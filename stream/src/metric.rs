...
define_metrics!(
    qps:    tx-tx, rx-rx, readerr-readerr,writeerr-writeerr, cps-cps, kps-kps, conn-conn, key-key, nilconvert-nilconvert;
    num: conn_num-conn, read-read, write-write, unsupport_cmd-unsupport_cmd;
    rtt:    avg-avg;
    ratio:  cache-hit
);
