...
pub(super) static SUPPORTED: Commands = {
    ...
    for c in vec![
        ...
        Cmd::new("get").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),

        // multi请求：异常响应需要改为$-1
        Cmd::new("mget").m("get").arity(-2).op(MGet).first(1).last(-1).step(1).padding(pt[6]).multi().key().bulk().nofwd(),

        Cmd::new("set").arity(-3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("incr").arity(2).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("decr").arity(2).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        ...
        Cmd::new("mset").m("set").arity(-3).op(Store).first(1).last(-1).step(2).padding(pt[6]).multi().key().val().nofwd(),
        Cmd::new("del").arity(-2).op(Store).first(1).last(-1).step(1).padding(pt[6]).multi().key().nofwd(),

        // 即便应对多语言，exists 也只支持一个key，否则需要计算多个后端数据，作为一个数字返回 fishermen
        Cmd::new("exists").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("expire").arity(3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("expireat").arity(3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("pexpire").arity(3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("pexpireat").arity(3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("persist").arity(2).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),

        // zset 相关指令
        Cmd::new("zadd").arity(-4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zincrby").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zrem").arity(-3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zremrangebyrank").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zremrangebyscore").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zremrangebylex").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zrevrange").arity(-4).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zcard").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zrange").arity(-4).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zrank").arity(3).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zrangebyscore").arity(-4).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),

        Cmd::new("zrevrank").arity(3).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zrevrangebyscore").arity(-4).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zrangebylex").arity(-4).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zrevrangebylex").arity(-4).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zcount").arity(4).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zlexcount").arity(4).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zscore").arity(3).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("zscan").arity(-3).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),

        // hset 支持多field、value，hmset后续会被deprecated
        Cmd::new("hset").arity(-4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("hsetnx").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("hmset").arity(-4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("hincrby").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("hincrbyfloat").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("hdel").arity(-3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("hget").arity(3).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("hgetall").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("hlen").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("hkeys").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("hmget").arity(-3).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("hvals").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("hexists").arity(3).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("hscan").arity(-3).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),

        Cmd::new("ttl").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("pttl").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("setnx").arity(3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("setex").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("append").arity(3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),

        // longset 相关指令,根据eredis 3.1 修改
        Cmd::new("lsset").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("lsdset").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("lsput").arity(-3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("lsdel").arity(-3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("lsmexists").arity(-3).op(Get).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("lsgetall").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("lsdump").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("lslen").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),

        // list 相关指令
        Cmd::new("rpush").arity(-3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("lpush").arity(-3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("rpushx").arity(-3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("lpushx").arity(-3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("linsert").arity(5).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("lset").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("rpop").arity(2).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("lpop").arity(2).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("llen").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("lindex").arity(3).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("lrange").arity(4).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("ltrim").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("lrem").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),

        // string 相关指令，包括 bit, str
        Cmd::new("setbit").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("getbit").arity(3).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("bitcount").arity(-2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("bitpos").arity(-3).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("bitfield").arity(-2).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("setrange").arity(4).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("getrange").arity(4).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("getset").arity(3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("strlen").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),

        // 测试完毕后规整到incr附近
        Cmd::new("incrby").arity(3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("decrby").arity(3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("incrbyfloat").arity(3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),

        // set 相关指令
        Cmd::new("sadd").arity(-3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("srem").arity(-3).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("sismember").arity(3).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("scard").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("spop").arity(-2).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("srandmember").arity(-2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("smembers").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("sscan").arity(-3).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        // set 多个key相关的指令
        Cmd::new("sinter").arity(-2).op(Get).first(1).last(-1).step(1).padding(pt[4]).need_resv_hash().key().nofwd(),
        Cmd::new("sunion").arity(-2).op(Get).first(1).last(-1).step(1).padding(pt[4]).need_resv_hash().key().nofwd(),
        Cmd::new("sdiff").arity(-2).op(Get).first(1).last(-1).step(1).padding(pt[4]).need_resv_hash().key().nofwd(),
        Cmd::new("sunionstore").arity(-3).op(Store).first(1).last(-1).step(1).padding(pt[4]).need_resv_hash().key().nofwd(),
        Cmd::new("sinterstore").arity(-3).op(Store).first(1).last(-1).step(1).padding(pt[4]).need_resv_hash().key().nofwd(),
        Cmd::new("sdiffstore").arity(-3).op(Store).first(1).last(-1).step(1).padding(pt[4]).need_resv_hash().key().nofwd(),
       
        // geo 相关指令
        Cmd::new("geoadd").arity(-5).op(Store).first(1).last(1).step(1).padding(pt[6]).key().val().nofwd(),
        Cmd::new("georadius").arity(-6).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("georadiusbymember").arity(-5).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("geohash").arity(-2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("geopos").arity(-2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("geodist").arity(-4).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),

        // pf相关指令
        Cmd::new("pfadd").arity(-2).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        ...
        Cmd::new("script").arity(-2).op(Store).padding(pt[6]).need_resv_hash(),
        Cmd::new("evalsha").arity(-3).op(Store).padding(pt[6]).need_resv_hash(),
        Cmd::new("eval").arity(-3).op(Store).padding(pt[6]).need_resv_hash(),

        //phantom
        Cmd::new("bfget").arity(2).op(Get).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("bfset").arity(2).op(Store).first(1).last(1).step(1).padding(pt[6]).key().nofwd(),
        Cmd::new("bfmget").m("bfget").arity(-2).op(MGet).first(1).last(-1).step(1).padding(pt[6]).multi().key().bulk().nofwd(),
        Cmd::new("bfmset").m("bfset").arity(-2).op(Store).first(1).last(1).step(1).padding(pt[6]).multi().key().bulk().nofwd(),
