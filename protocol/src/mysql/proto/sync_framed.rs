...
use crate::{
    mysql::constants::DEFAULT_MAX_ALLOWED_PACKET,
    mysql::proto::codec::{error::PacketCodecError, PacketCodec},
};
...
#[cfg(test)]
mod tests {
    use crate::mysql::{constants::MAX_PAYLOAD_LEN, proto::sync_framed::MySyncFramed};
