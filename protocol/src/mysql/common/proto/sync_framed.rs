...
use crate::{
    mysql::common::constants::DEFAULT_MAX_ALLOWED_PACKET,
    mysql::common::proto::codec::{error::PacketCodecError, PacketCodec},
};
...
#[cfg(test)]
mod tests {
    use crate::mysql::common::{constants::MAX_PAYLOAD_LEN, proto::sync_framed::MySyncFramed};
