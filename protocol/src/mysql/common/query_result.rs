...
use crate::mysql::common::constants::StatusFlags;
pub use crate::mysql::common::proto::{Binary, Text};

use crate::mysql::common::{
    io::ParseBuf, packets::OkPacket, row::RowDeserializer, value::ServerSide,
};
use crate::mysql::rsppacket::ResponsePacket;

use std::{borrow::Cow, marker::PhantomData, sync::Arc};

use crate::mysql::common::packets::Column;
use crate::mysql::common::row::Row;
...
#[derive(Debug)]
pub(crate) struct QueryResult<'c, T: crate::mysql::prelude::Protocol, S: Stream> {
    // conn: ConnMut<'c, 't, 'tc>,
...
#[derive(Debug)]
pub(crate) struct ResultSet<'a, 'd, T: crate::mysql::prelude::Protocol, S: Stream> {
    set_index: usize,
