...
fn crc32_delimiter_hasher() {
    let key = [
        99u8, 97, 113, 119, 111, 46, 112, 120, 121, 46, 113, 121, 54, 51, 98, 109, 113, 122, 46,
        108, 101, 119, 46, 56, 51, 52, 56, 48, 51, 52, 49, 51, 108, 103, 120, 114, 97, 99, 54, 48,
        53, 54, 52, 48, 48, 103, 108, 52, 56, 49, 56, 57, 48, 100, 120, 104, 115, 118, 110, 54, 50,
        50, 48, 51, 52, 100, 117, 105, 97, 102, 51, 51, 50, 51,
    ];
    let key = &&key[..];
...
fn crc32_smartnum_hasher() {
    let key = [
        57, 48, 50, 54, 106, 46, 119, 99, 104, 109, 114, 98, 115, 46, 121, 116, 114, 108, 122, 120,
        108, 101, 113, 117, 106, 108, 120, 119, 116, 101, 48, 50, 46, 50, 105, 56, 105, 105, 115,
        52, 114, 110, 117, 99, 112, 98, 108, 113, 98, 99, 118, 112, 99, 102, 103, 118, 53, 46, 51,
        54, 52, 112, 102, 117, 114, 107, 107, 120, 97, 112, 111, 106, 100, 111, 103, 103, 103, 117,
        101, 101, 98,
    ];
