use super::DivMod;
use crate::distribution::{DIST_RANGE_SLOT_COUNT_DEFAULT, DIST_RANGE_WITH_SLOT_PREFIX, DIST_RANGE};
...
impl Range {
    pub fn from(name: &str, shards: usize) -> DivMod {
        Self::div_mod(name, shards)
    }
    ...
    pub(super) fn div_mod(name: &str, shards: usize) -> DivMod {
        ...
        DivMod::pow(slot, slot, slot / shards)
    }
